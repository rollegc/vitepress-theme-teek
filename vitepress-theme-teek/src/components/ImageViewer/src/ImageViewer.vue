        ...
        >
          ...
          <div :class="[ns.e('btn'), ns.e('actions')]">
            <div :class="ns.e('actions__inner')">
              ...
              >
                <Icon :icon="zoomOutIcon" @click="handleActions('zoomOut')" />
                <Icon :icon="zoomInIcon" @click="handleActions('zoomIn')" />
                <i :class="ns.e('actions__divider')" />
                <Icon :icon="mode.icon" @click="toggleMode" />
                <i :class="ns.e('actions__divider')" />
                <Icon :icon="refreshLeftIcon" @click="handleActions('anticlockwise')" />
                <Icon :icon="refreshRightIcon" @click="handleActions('clockwise')" />
              </slot>
            </div>
          </div>
          <!-- CANVAS -->
