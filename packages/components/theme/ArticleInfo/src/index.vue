...
const baseInfo = computed(() => {
  ...
  return [
    ...
    },
    {
      ...
      show: updateDate.value && ((scope === "article" && showUpdateDate) || scope === "article-info"),
    },
    {
      ...
      class: "or",
      show: scope !== "article-info" && (scope === "post" || isShow(showCategory)),
    },
    {
      ...
      href: "/tags?tag={data}",
      class: "or",
      show: scope !== "article-info" && (scope === "post" || isShow(showTag)),
    },
  ];
});
