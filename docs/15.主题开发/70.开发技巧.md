...
可以在组件 [Layout](https://github.com/Kele-Bingtang/vitepress-theme-teeker/blob/master/vitepress-theme-teeker/src/layout/index.vue) 的评论区相关代码或者 [HomeBanner](https://github.com/Kele-Bingtang/vitepress-theme-teeker/blob/master/vitepress-theme-teeker/src/components/HomeBanner/src/index.vue) 查看具体使用。
...
可以在组件 [ArticleInfo](https://github.com/Kele-Bingtang/vitepress-theme-teeker/blob/master/vitepress-theme-teeker/src/components/ArticleInfo/src/index.vue) 查看具体使用。
