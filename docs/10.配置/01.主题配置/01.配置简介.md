...
export default {
  ...
  Layout: defineComponent({
    name: "TeekProvider",
    setup() {
      provide(teekConfigSymbol, { author: { name: "Teeker" } });
...
Teek 支持的主题配置请阅读 [Types](https://github.com/Kele-Bingtang/vitepress-theme-teek/blob/master/vitepress-theme-teek/src/config/types.ts) 文件。
