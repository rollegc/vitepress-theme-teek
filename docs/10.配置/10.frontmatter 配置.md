...
可以填写 HTML 标签 <Badge type="tip" text="v1.3.0" />，如：

```
---
title: frontmatter 配置 <span style="color:#395AE3">精选</span>
---
```

或者使用 VitePress 的 `Badge` 组件：

```
---
title: frontmatter 配置 <Badge type="tip" text="v1.2.0" />
---
```
