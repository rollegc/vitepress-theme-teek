...
`docAnalysisOption` 的详细配置项请看 [Catalogue 配置项](https://github.com/Kele-Bingtang/vitepress-theme-teeker/blob/master/plugins/vitepress-plugin-doc-analysis/src/types.ts)。
...
`autoFrontmatterOption` 的详细配置项请看 [Catalogue 配置项](https://github.com/Kele-Bingtang/vitepress-theme-teeker/blob/master/plugins/vitepress-plugin-auto-frontmatter/src/types.ts)。
