...
本文记录 Teeker 在成长过程中帮忙测试、开发的小伙伴们，以及 Teeker 参考的其他优质 Vitepress、vuepress 主题，感谢你们让 Teeker 更加优秀。

## 主题

Teeker 的灵感主要来自于 [vuepress-theme-vdoing](https://doc.xugaoyi.com/)，在 Vitepress 没有出来之前，Teeker 使用 `vuepress-theme-vdoing` 搭建的博客站。
